...
values_header_nst = "Timestamp,AF3 Value,AF3 Quality,AF4 Value,AF4 Quality,F3 Value,F3 Quality,F4 Value,F4 Quality,F7 Value," \
                "F7 Quality,F8 Value,F8 Quality\n"


def writer_task_to_line_nst(next_task):
    return "{timestamp},{af3_value},{af3_quality},{af4_value},{af4_quality},{f3_value}," \
           "{f3_quality},{f4_value},{f4_quality},{f7_value},{f7_quality},{f8_value}," \
           "{f8_quality}\n".format(
        timestamp=str(next_task.timestamp),
